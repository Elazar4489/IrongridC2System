...
CREATE DATABASE IF NOT EXISTS IrongridC2SystemDB;
USE IrongridC2SystemDB;
...
-- and the primary key according to the project specification.
 CREATE TABLE IF NOT EXISTS Units( Id INT PRIMARY KEY AUTO_INCREMENT,  UnitName VARCHAR(50) DEFAULT  "Unknown Unit",  Sector VARCHAR(50) DEFAULT "General" );
...
-- Define all required columns, data types, constraints,
-- and the primary key according to the project specification.
CREATE TABLE IF NOT EXISTS Assets( Id INT PRIMARY KEY AUTO_INCREMENT, UnitId INT, AssetSerial VARCHAR(50) NOT NULL,  Type VARCHAR(50) DEFAULT "GenericAsset", FOREIGN KEY (UnitId)      REFERENCES Units (Id) );
...
-- Define all required columns, data types, constraints,
-- and the primary key according to the project specification.
CREATE TABLE IF NOT EXISTS AssetLiveStatuses( AssetId INT PRIMARY KEY, AssetType VARCHAR(50), RawValue VARCHAR(50) NOT NULL, ProcessedStatus VARCHAR(50), IsVerified BOOLEAN NOT NULL, LastUpdate DATETIME NOT NULL );
